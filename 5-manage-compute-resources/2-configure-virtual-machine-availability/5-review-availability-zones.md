...
> **Tip:** To achieve comprehensive business continuity on Azure, build your application architecture with a combination of availability zones and Azure [regional pairs](https://learn.microsoft.com/en-us/azure/virtual-machines/regions#region-pairs).