...
8.  | From the **Overview** | **Create by adding HTTP requests**, select **Create**. |
    | --- |  --- |
...
11.  Navigate to the test (it is listed on the home page).

12.  Refresh and review the live metrics including **Virtual users**, **Response time**, and **Requests/sec**.

13.  Select **Stop** to complete the test run. You don't need to wait for the test to complete.
