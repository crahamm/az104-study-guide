...
**Tip:** For a more complete review of virtual networks, consider the [Introduction to Virtual Networks](https://learn.microsoft.com/en-us/training/modules/introduction-to-azure-virtual-networks/) training module.