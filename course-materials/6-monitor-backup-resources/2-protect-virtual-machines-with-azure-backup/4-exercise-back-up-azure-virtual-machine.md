...
> **Note:** If you get a `securityProfile.securityType is invalid` error running the preceding command, run the following commands to register `UseStandardSecurityType`, then re-run the preceding command.
>
>Azure CLI
>
>```
